...
if (Config.WORKTYPE == 'private') {
    ...
    Mbe.addCommand({pattern: 'alive', fromMe: true, desc: Lang.ALIVE_DESC}, (async (message, match) => {
        ...
        if (Config.ALIVEMSG == 'default') {
            await message.client.sendMessage(message.jid,'```MbeWp Yazılımı Çalışıyor!```\n\n*Version:* ```'+Config.VERSION+'```\n*Branch:* ```'+Config.BRANCH+'```\n*Developed by  Burak Eyidoğan - MBE Software* ' + Config.CHANNEL , MessageType.text);
        }
        else {
            const pow = '*Developed by Burak Eyidoğan*'
    ...
    Mbe.addCommand({pattern: 'alive', fromMe: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
    ...
    Mbe.addCommand({pattern: 'sysd', fromMe: false, desc: Lang.SYSD_DESC}, (async (message, match) => {
