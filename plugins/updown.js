...
if (pb.WORKTYPE == 'private') {
    Mbe.addCommand({ pattern: '.', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    Mbe.addCommand({ pattern: '.', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        if(message.fromMe) return
        let command = [ 
        'xmedia',
        'install',
