...
const Lang = Language.getString('_mbe');

if (Config.WORKTYPE == 'private') {

    Mbe.addCommand({pattern: 'mbe ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Mbe.addCommand({pattern: 'mbe ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
