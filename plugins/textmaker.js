...
Mbe.addCommand({pattern: 'textmaker$', fromMe: wk, desc: desc_msg}, (async (message, match) => {
    var t1 = ''
    var t2 = ''
    var t3 = ''
    var t4 = ''
...
Mbe.addCommand({pattern: 'textdevil ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-neon-devil-wings-text-effect-online-free-1014.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/devil.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/devil.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textbear ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/online-black-and-white-bear-mascot-logo-creation-1012.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/bear.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/bear.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textwolf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    ...
    thiccysapi.textpro("https://textpro.me/create-wolf-logo-galaxy-online-936.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/wolf.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/wolf.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textneon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-a-futuristic-technology-neon-light-text-effect-1006.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/neon.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/neon.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'text2neon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/neon-text-effect-online-879.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/neon2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/neon2.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textlight ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/thunder-text-effect-online-881.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/li.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/li.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textjoker ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/create-logo-joker-online-934.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/joker.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/joker.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textninja ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-ninja-logo-online-935.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/ninja.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/ninja.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textglitter ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/advanced-glow-text-effect-873.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/tt.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/tt.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textbokeh ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/bokeh-text-effect-876.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/bkh.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/bkh.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textmarvel ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-logo-style-marvel-studios-online-971.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/marvel.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/marvel.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'text2marvel ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-3d-avengers-logo-online-974.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/mar2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/mar2.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textavengers ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-3d-avengers-logo-online-974.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/aven.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/aven.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textglitch ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/tt2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/tt2.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textgraf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-cool-wall-graffiti-text-effect-online-1009.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/ttgra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/ttgra.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'text2graf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-a-cool-graffiti-text-on-the-wall-1010.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/t2gra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/t2gra.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textlion ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-lion-logo-mascot-online-938.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/lion.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/lion.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'text3neon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/neon-text-effect-online-963.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/neon3.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/neon3.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textice ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.textpro("https://textpro.me/ice-cold-text-effect-862.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/ice.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/ice.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textspace ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var topText, bottomText; 
    if (match[1].includes(';')) {
        var split = match[1].split(';');
        topText = split[0];
    ...
    thiccysapi.textpro("https://textpro.me/create-space-3d-text-effect-online-985.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/space.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/space.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textsmoke ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.photooxy("https://photooxy.com/other-design/create-an-easy-smoke-type-effect-390.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/smoke.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/smoke.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textglow ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var download = async(uri, filename, callback) => {
        await request.head(uri, async(err, res, body) => {    
            await request(uri).pipe(fs.createWriteStream(filename)).on('close', callback);
        });
    ...
    await download(`https://api.xteam.xyz/photooxy/neonlight?text=${uri}&APIKEY=da5fb2b73ae3e451`, '/root/mbewp/glowttp.jpg', async() => {                          
        await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/glowttp.jpg'), MessageType.image, { caption: 'Made by mbewp' })
    })
}));
Mbe.addCommand({pattern: 'textfire ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/realistic-flaming-text-effect-online-197.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/tfire.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/tfire.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textharry ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/create-harry-potter-text-on-horror-background-178.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/hp.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/hp.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'text4neon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/illuminated-metallic-effect-177.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/t4n.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/t4n.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textcemetery ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/text-on-scary-cemetery-gate-172.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/cmth.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/cmth.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Mbe.addCommand({pattern: 'textcup ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/put-text-on-the-cup-387.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/mbewp/cup.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/mbewp/cup.jpg'), MessageType.image, { caption: 'Made by mbewp' })
              })
          } catch(err) { 
              console.log(err)
          } 
